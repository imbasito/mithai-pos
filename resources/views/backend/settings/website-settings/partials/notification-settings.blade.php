<form action="{{ route('backend.admin.settings.website.notification.settings.update') }}" method="post">
    @csrf
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group mb-4">
                        ...
                        <input class="form-control border-radius-10" name="notify_email_address" type="email"
